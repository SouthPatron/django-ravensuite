...
class RefundList( AccountPageView ):
	template_name = 'pages/org/client/account/transaction/refund/index'
...
class RefundDraftList( AccountPageView ):
	template_name = 'pages/org/client/account/transaction/refund/draft-index'
...
class RefundUnallocatedList( AccountPageView ):
	template_name = 'pages/org/client/account/transaction/refund/unallocated-index'
...
class RefundSingle( AccountPageView ):
	template_name = 'pages/org/client/account/transaction/refund/single'
	...
	def get_object( self, request, *args, **kwargs ):
		...
		if obj.document_state == SourceDocumentState.DRAFT:
			self.template_name = 'pages/org/client/account/transaction/refund/single-draft'
		elif obj.document_state == SourceDocumentState.FINAL:
			self.template_name = 'pages/org/client/account/transaction/refund/single-final'
		elif obj.document_state == SourceDocumentState.VOID:
			self.template_name = 'pages/org/client/account/transaction/refund/single-void'
	...
	def update_object( self, request, data, *args, **kwargs ):
		...
		if state == SourceDocumentState.DELETE:
			...
			messages.info( request, _('VMG_20008') )
			return redirect( obj.get_client().get_draft_refund_list_url() )
