...
class PaymentList( AccountPageView ):
...
class PaymentDraftList( AccountPageView ):
...
class PaymentUnallocatedList( AccountPageView ):
...
class PaymentSingle( AccountPageView ):
