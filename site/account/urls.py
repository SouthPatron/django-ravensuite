...
urlpatterns = patterns('',
	...
	url( r'^organizations$', login_required( OrgList.as_view() ), name = 'account-org-list' ),
	url( r'^organization/(?P<oid>\w{32})$', login_required( OrgSingle.as_view() ), name = 'account-org-single' ),
