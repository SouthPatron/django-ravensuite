...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.refnum'
        db.delete_column('common_userprofile', 'refnum')


        # Changing field 'Organization.refnum'
        db.alter_column('common_organization', 'refnum', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32))
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'UserProfile.refnum'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.refnum' and its values cannot be restored.")

        # Changing field 'Organization.refnum'
        db.alter_column('common_organization', 'refnum', self.gf('django.db.models.fields.BigIntegerField')(unique=True))
    models = {
        'auth.group': {
        ...
        'common.organization': {
            ...
            'physical_address': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'postal_address': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'refnum': ('django.db.models.fields.CharField', [], {'default': "'9f4ef974c6cb4786a10f93c5c254f6a6'", 'unique': 'True', 'max_length': '32'}),
            'telephone_number': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '64', 'blank': 'True'}),
            'trading_name': ('django.db.models.fields.CharField', [], {'max_length': '192'})
        },
