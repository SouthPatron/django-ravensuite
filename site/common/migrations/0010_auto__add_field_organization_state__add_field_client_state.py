...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('common_organization', 'state',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Client.state'
        db.add_column('common_client', 'state',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Organization.state'
        db.delete_column('common_organization', 'state')

        # Deleting field 'Client.state'
        db.delete_column('common_client', 'state')
    ...
    models = {
        ...
        'common.organization': {
            ...
            'physical_address': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'postal_address': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'refnum': ('django.db.models.fields.CharField', [], {'default': "'6507bbb462b147ef819863e3d7c66de7'", 'unique': 'True', 'max_length': '32'}),
            'state': ('django.db.models.fields.IntegerField', [], {}),
            'telephone_number': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '64', 'blank': 'True'}),
            'trading_name': ('django.db.models.fields.CharField', [], {'max_length': '192'})
        },
