...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TimesheetTimer.timesheet_entry'
        raise RuntimeError("Cannot reverse this migration. 'TimesheetTimer.timesheet_entry' and its values cannot be restored.")
    models = {
        'auth.group': {
        ...
        'common.organization': {
            ...
            'physical_address': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'postal_address': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'refnum': ('django.db.models.fields.CharField', [], {'default': "'a619abd5a7e74941ac40ba9ff0c8b1be'", 'unique': 'True', 'max_length': '32'}),
            'state': ('django.db.models.fields.IntegerField', [], {}),
            'telephone_number': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '64', 'blank': 'True'}),
            'trading_name': ('django.db.models.fields.CharField', [], {'max_length': '192'})
        },
