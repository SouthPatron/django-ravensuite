...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TimesheetTimer.task'
        db.delete_column('common_timesheettimer', 'task_id')

        # Deleting field 'TimesheetTimer.description'
        db.delete_column('common_timesheettimer', 'description')

        # Deleting field 'TimesheetTimer.project'
        db.delete_column('common_timesheettimer', 'project_id')

        # Deleting field 'TimesheetTimer.user'
        db.delete_column('common_timesheettimer', 'user_id')

        # Adding field 'TimesheetTimer.timesheet_entry'
        db.add_column('common_timesheettimer', 'timesheet_entry',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['common.TimesheetEntry']),
                      keep_default=False)

        # Deleting field 'TimesheetEntry.description'
        db.delete_column('common_timesheetentry', 'description')

        # Deleting field 'TimesheetEntry.end_time'
        db.delete_column('common_timesheetentry', 'end_time')

        # Adding field 'TimesheetEntry.comment'
        db.add_column('common_timesheetentry', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'TimesheetEntry.seconds'
        db.add_column('common_timesheetentry', 'seconds',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TimesheetTimer.task'
        raise RuntimeError("Cannot reverse this migration. 'TimesheetTimer.task' and its values cannot be restored.")
        # Adding field 'TimesheetTimer.description'
        db.add_column('common_timesheettimer', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'TimesheetTimer.project'
        raise RuntimeError("Cannot reverse this migration. 'TimesheetTimer.project' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'TimesheetTimer.user'
        raise RuntimeError("Cannot reverse this migration. 'TimesheetTimer.user' and its values cannot be restored.")
        # Deleting field 'TimesheetTimer.timesheet_entry'
        db.delete_column('common_timesheettimer', 'timesheet_entry_id')

        # Adding field 'TimesheetEntry.description'
        db.add_column('common_timesheetentry', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'TimesheetEntry.end_time'
        raise RuntimeError("Cannot reverse this migration. 'TimesheetEntry.end_time' and its values cannot be restored.")
        # Deleting field 'TimesheetEntry.comment'
        db.delete_column('common_timesheetentry', 'comment')

        # Deleting field 'TimesheetEntry.seconds'
        db.delete_column('common_timesheetentry', 'seconds')
    ...
    models = {
        ...
        'common.organization': {
            ...
            'physical_address': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'postal_address': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'refnum': ('django.db.models.fields.CharField', [], {'default': "'f6f16f65d9834cfbaf988365ad4ab6eb'", 'unique': 'True', 'max_length': '32'}),
            'state': ('django.db.models.fields.IntegerField', [], {}),
            'telephone_number': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '64', 'blank': 'True'}),
            'trading_name': ('django.db.models.fields.CharField', [], {'max_length': '192'})
        },
        ...
        'common.timesheetentry': {
            ...
            'seconds': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
        ...
        'common.timesheettimer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {}),
            'timesheet_entry': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.TimesheetEntry']"})
        },
