...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.telephone_number'
        db.add_column('common_client', 'telephone_number', self.gf('django.db.models.fields.CharField')(default=u'', max_length=64), keep_default=False)

        # Adding field 'Client.fax_number'
        db.add_column('common_client', 'fax_number', self.gf('django.db.models.fields.CharField')(default=u'', max_length=64), keep_default=False)

        # Adding field 'Client.email_address'
        db.add_column('common_client', 'email_address', self.gf('django.db.models.fields.CharField')(default=u'', max_length=256), keep_default=False)

        # Adding field 'Client.postal_address'
        db.add_column('common_client', 'postal_address', self.gf('django.db.models.fields.TextField')(default=u''), keep_default=False)

        # Adding field 'Client.physical_address'
        db.add_column('common_client', 'physical_address', self.gf('django.db.models.fields.TextField')(default=u''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.telephone_number'
        db.delete_column('common_client', 'telephone_number')

        # Deleting field 'Client.fax_number'
        db.delete_column('common_client', 'fax_number')

        # Deleting field 'Client.email_address'
        db.delete_column('common_client', 'email_address')

        # Deleting field 'Client.postal_address'
        db.delete_column('common_client', 'postal_address')

        # Deleting field 'Client.physical_address'
        db.delete_column('common_client', 'physical_address')
    ...
    models = {
        ...
        'common.client': {
            ...
            'email_address': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '256'}),
            'fax_number': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '64'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.Organization']"}),
            'physical_address': ('django.db.models.fields.TextField', [], {'default': "u''"}),
            'postal_address': ('django.db.models.fields.TextField', [], {'default': "u''"}),
            'refnum': ('django.db.models.fields.BigIntegerField', [], {}),
            'telephone_number': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '64'}),
