...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
		try:
			syscount = orm.SystemCounter.objects.get( id = 1 )
		except:
			syscount = orm.SystemCounter()
			syscount.id = 1
			syscount.profile_no = 1
			syscount.organization_no = 1
			syscount.save()
    ...
    def backwards(self, orm):
		try:
			syscount = orm.SystemCounter.objects.get( id = 1 )
			syscount.delete()
		except orm.SystemCounter.DoesNotExist:
			pass
