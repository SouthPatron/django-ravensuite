...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.telephone_number'
        db.add_column('common_organization', 'telephone_number', self.gf('django.db.models.fields.CharField')(default=u'', max_length=64, blank=True), keep_default=False)

        # Adding field 'Organization.fax_number'
        db.add_column('common_organization', 'fax_number', self.gf('django.db.models.fields.CharField')(default=u'', max_length=64, blank=True), keep_default=False)

        # Adding field 'Organization.email_address'
        db.add_column('common_organization', 'email_address', self.gf('django.db.models.fields.CharField')(default=u'', max_length=256, blank=True), keep_default=False)

        # Adding field 'Organization.postal_address'
        db.add_column('common_organization', 'postal_address', self.gf('django.db.models.fields.TextField')(default=u'', blank=True), keep_default=False)

        # Adding field 'Organization.physical_address'
        db.add_column('common_organization', 'physical_address', self.gf('django.db.models.fields.TextField')(default=u'', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.telephone_number'
        db.delete_column('common_organization', 'telephone_number')

        # Deleting field 'Organization.fax_number'
        db.delete_column('common_organization', 'fax_number')

        # Deleting field 'Organization.email_address'
        db.delete_column('common_organization', 'email_address')

        # Deleting field 'Organization.postal_address'
        db.delete_column('common_organization', 'postal_address')

        # Deleting field 'Organization.physical_address'
        db.delete_column('common_organization', 'physical_address')
